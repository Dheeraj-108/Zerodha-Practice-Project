            ...
            <div className='flex justify-between md:justify-around items-center h-16 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto'>
                ...
                <div className="navbar-right hidden md:block">
                    <ul className='list-none flex gap-6 lg:gap-10 text-gray-600 text-sm lg:text-base'>
                        <li className='cursor-pointer hover:text-blue-600 transition-colors duration-200'> <Link to="/signup">Signup</Link></li>
                        <li className='cursor-pointer hover:text-blue-600 transition-colors duration-200'> <Link to="/about">About</Link></li>
                        <li className='cursor-pointer hover:text-blue-600 transition-colors duration-200'>  <Link to="/product">Products</Link></li>
                        <li className='cursor-pointer hover:text-blue-600 transition-colors duration-200'> <Link to="/pricing">Pricing</Link></li>
                        <li className='cursor-pointer hover:text-blue-600 transition-colors duration-200'> <Link to="/support">Support</Link></li>
                    </ul>
                </div>
